...
###############################################
This program is the same as the multiblink program, but is 
flashed to the MSP430 and implemented on a breadboard. Pin 1 is 
connected to power, Pin 2 is connected through a 500 ohm resistor 
to the green LED which is connected to ground (pin 1.0 in the program). 
Pin 14 is connected through a 1kOhm resistor to a red LED which is connected 
to ground. Pin 16 is connected directly to power because it is the reset pin, 
